...
var player_1 = require("../engine/player");
var GameManager = function () {
    var _a;
    var _instanceExtraInitializers = [];
    var _move_decorators;
    var _attack_decorators;
    var _nextTurn_decorators;
    return _a = /** @class */ (function () {
            function GameManager(rule, boardConfig, player1, player2) {
                var _a;
                ...
                //Init Players
                this.__players = (_a = {},
                    _a[environments_1.Color.BLUE] = player1,
                    _a[environments_1.Color.RED] = player2,
                    _a[environments_1.Color.WHITE] = new player_1.Player(environments_1.Color.WHITE),
                    _a);
                ...
                this.tiles_manager.dev_addbuilding(new Building_1.Building({
                    "properties": {},
                    'apparence': {
                        'str': '🝚 '
                    }
                }, environments_1.Color.WHITE), new math_1.Vector2D(0, 1));
                this.tiles_manager.dev_addbuilding(new Building_1.Building({
                    "properties": {},
                    'apparence': {
                        'str': '🝚 '
                    }
                }, environments_1.Color.WHITE), new math_1.Vector2D(1, 1));
        ...
        (function () {
            _move_decorators = [CheckPawnColorTurn];
            _attack_decorators = [CheckPawnColorTurn, logic_cond_1.CheckVictory];
            _nextTurn_decorators = [logic_cond_1.CheckVictory];
            ...
            __esDecorate(_a, null, _nextTurn_decorators, { kind: "method", name: "nextTurn", static: false, private: false, access: { has: function (obj) { return "nextTurn" in obj; }, get: function (obj) { return obj.nextTurn; } } }, null, _instanceExtraInitializers);
        })(),
        _a;
}();
exports.GameManager = GameManager;
//# sourceMappingURL=BaseGameManager.js.map